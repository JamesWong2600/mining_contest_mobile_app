...
export default function Feedback_type() {
...
*/
     const handleCheatingReport = async () => {
      navigation.navigate('Cheating_report');
    };
      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.contentContainer}>
            <TouchableOpacity 
              ...
              onPress={handleCheatingReport}
            >
              <View style={styles.cardHeader}>
                <Text style={styles.cardTitle}>舉報玩家作弊</Text>
                <View style={[
                  styles.statusBadge,
                  { backgroundColor: 'green'}
                ]}
                >
                  <Text style={styles.statusText}>匿名</Text>
                </View>
              </View>
              
              <View style={styles.cardContent}>
                <Text style={styles.dateText}>可以舉報比賽過程中作弊的玩家</Text>
              </View>
            </TouchableOpacity>
             <TouchableOpacity 
              style={styles.competitionCard}
            ...
            >
              <View style={styles.cardHeader}>
                <Text style={styles.cardTitle}>給比賽提供建議</Text>
              </View>
              
              <View style={styles.cardContent}>
                <Text style={styles.dateText}>可以給比賽提供改善的建議</Text>
              </View>
            </TouchableOpacity>
        </View>
      </ScrollView>
